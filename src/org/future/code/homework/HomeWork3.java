...
public class  HomeWork3 {
     ...
     * Задание:
     *
     * 1. Реализуйте метод raiseException(ниже) который примет число и выбрасывает исключения:
    ...
    public static void raiseException(Integer exceptionId) throws Exception { // Подсказка: throws Exception в итоге надо поменять на перечисление имен исключений
        ...
        switch (exceptionId){
            ...
            case 3 -> throw new AccessDeniedException("bondage");
            case 4 -> throw new ExportException("bandage");
        }
    }
